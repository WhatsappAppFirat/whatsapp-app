...
var ReactCodeInput = function (_Component) {
  ...
  function ReactCodeInput(props) {
    ...
    var _this$updateValues = _this.updateValues(),
        vals = _this$updateValues.vals,
        autoFocusIndex = _this$updateValues.autoFocusIndex;

    _this.state = { values: vals, autoFocusIndex: autoFocusIndex };

    _this.iRefs = [];
    for (var i = 0; i < fields; i++) {
      _this.iRefs.push(React__default.createRef());
    }
    _this.id = +new Date();
  ...
  createClass(ReactCodeInput, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      if (Array.isArray(values) && this.checkDifferenceArray(values, this.props.values) || values !== this.props.values) {
        var _updateValues = this.updateValues(),
            vals = _updateValues.vals,
            autoFocusIndex = _updateValues.autoFocusIndex;

        this.setState({ values: vals, autoFocusIndex: autoFocusIndex });
      }
    }
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        loading && React__default.createElement(
          ...
          React__default.createElement('div', { className: styles['blur'] }),
          React__default.createElement(
            'svg',
            {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.updateValues = function () {
    ...
    return { vals: vals, autoFocusIndex: autoFocusIndex };
  };

  this.checkDifferenceArray = function (prev, curr) {
    return !Array.isArray(prev) || !Array.isArray(curr) || prev.length !== curr.length || JSON.stringify(prev) !== JSON.stringify(curr);
  };
